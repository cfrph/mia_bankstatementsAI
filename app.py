...
def upload():
    ...
    if processor_name == "capone":
        ...
        if response_json is None:
            return "Failed to process CapOne document", 500
        ...
        if response_json is None:
            return "Failed to process Chase7772 document", 500
        ...
        if response_json is None:
            return "Failed to process TCB document", 500
        ...
        with zipfile.ZipFile(output_zip, mode="w") as zf:
            ...
            debit_writer.writerow(
                ["Journal#", "Date", "Short Desc", "Full Desc", "Amount", "Account#"]
            )
            ...
            credit_writer.writerow(
                ["Deposit#", "Date", "Short Desc", "Full Desc", "Amount", "Account#"]
            )
            ...
            if unmapped:
                ...
                unmapped_writer.writerow(
                    ["Entry#", "Date", "Short Desc", "Full Desc", "Amount", "Account#"]
                )
        ...
        return Response(
            ...
            headers={
                "Content-Disposition": "attachment;filename=multiledger_tcb_export.zip"
            },
        )
